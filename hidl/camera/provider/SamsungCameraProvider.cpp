...
#if !defined(EXYNOS9820_MODEL_beyond0lte) && !defined(EXYNOS9820_MODEL_m62)
    // ID=52 is telephoto
...
#ifdef EXYNOS9820_MODEL_m62
   // ID=20 is 64MP camera bundled with 12MP UW (ID=50)
   mExtraIDs.push_back(20);
   // ID=50 is a dependency of ID=20
