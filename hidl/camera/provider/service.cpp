 ...
 * Copyright 2021-2023 The LineageOS Project
 *
...
#define LOG_TAG "android.hardware.camera.provider@2.6-service.exynos9820"
...
int main()
{
    ...
    ALOGI("CameraProvider@2.6 legacy service is starting.");

    ::android::hardware::configureRpcThreadpool(/*threads*/ 6, /*willJoin*/ true);

    ::android::sp<ICameraProvider> provider = new SamsungCameraProvider();
